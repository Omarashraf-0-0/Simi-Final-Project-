...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
      displayLarge: const TextStyle().copyWith(fontSize: 64.0, fontWeight: FontWeight.bold, color: Colors.black),
      displayMedium: const TextStyle().copyWith(fontSize: 52.0, fontWeight: FontWeight.w600, color: Colors.black),
      displaySmall: const TextStyle().copyWith(fontSize: 44.0, fontWeight: FontWeight.bold, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
      ...
      displayMedium: const TextStyle().copyWith(fontSize: 52.0, fontWeight: FontWeight.w600, color: Colors.white),
      displaySmall: const TextStyle().copyWith(fontSize: 44.0, fontWeight: FontWeight.bold, color: Colors.white),
